...
| 3 | Resource Gathering | Proximity-based auto-gather with tool gates, yield amounts, gather radius, resource depletion and respawn timers | Implemented | Auto-Interaction | auto_interaction_system.gd | PropNode, PropDef |
