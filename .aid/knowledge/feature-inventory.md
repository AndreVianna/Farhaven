...
| 6 | Scanner / Catalog | Proximity auto-scan, knowledge states (UNKNOWN→ENCOUNTERED→CATALOGED), catalog discovery driven by PropDef + CatalogableCap (single source of truth, post-006b) | Implemented | Scanner/Catalog | scanner_system.gd, catalog.gd | PropDef, CatalogableCap |
