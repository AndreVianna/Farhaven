...
| 4 | Inventory | Weight-based inventory (12 base slots + 4 tool slots, capacity_weight=50.0). Primary constraint is total weight; items grouped by type for display. | Implemented (refactored 005a) | Inventory | inventory.gd | PropDef.portable.weight |
