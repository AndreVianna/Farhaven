...
**Scope:**
- Implement `ResourceDefModel` data class:
...
**Acceptance Criteria:**
- [ ] `ResourceDefModel.fromTres()` correctly parses all fields from existing .tres files
- [ ] `ResourceDefModel.toTres()` produces valid .tres output that round-trips correctly
