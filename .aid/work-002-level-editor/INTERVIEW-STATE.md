...
**Source:** /aid-interview (cross-reference vs resource_def.gd)
...
**Answer:** Accepted. Expose all text/number/color fields in the Resource Editor form. Mesh/Material references shown as read-only (path or "not set"). Update REQUIREMENTS.md §4 with the correct field list from resource_def.gd.
**Status:** Answered
