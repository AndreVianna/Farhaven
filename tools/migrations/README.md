...
| 2026-04-18 | `2026-04-18-placement-into-placeable.py` | Merge PlacementCap into PlaceableCap per Andre's UX feedback. Inlines `placement = N` into placeable_1 sub_resource, deletes placement_1 sub_resource + placement_cap.gd ext_resource. `PlacementCap` class removed entirely. |
